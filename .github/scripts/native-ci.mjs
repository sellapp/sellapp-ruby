    ...
    "commands": [
      ...
      },
      {
        ...
        "args": [
          ...
          "-Ilib:test",
          "-e",
          "Dir['test/**/*_test.rb', 'test/**/test_*.rb'].sort.each { |file| require File.expand_path(file) }"
        ]
      },
      {
        "stage": "package",
      ...
      },
      {
        ...
        "args": [
          "-e",
          "spec = Gem::Specification.load('sellapp.gemspec'); abort('Cannot read gemspec') unless spec; exec('gem', 'install', '--install-dir', '.validation-gems', '--no-document', spec.file_name)"
        ]
      },
      {
        "stage": "import",
        ...
        "args": [
          "-e",
          "gem 'sellapp', Gem::Specification.load('sellapp.gemspec').version.to_s; require 'sellapp'"
        ],
        "env": {
          "GEM_HOME": "$SDK_ROOT/.validation-gems",
          "GEM_PATH": "$SDK_ROOT/.validation-gems"
        }
      },
      {
        "stage": "documentation",
      ...
      },
      {
        ...
        "args": [
          ...
          "ruby",
          "-Ilib",
          "$SDK_ROOT/.github/scripts/validate-ruby-operation-snippets.rb",
          "$SDK_ROOT"
        ]
      }
    ]
